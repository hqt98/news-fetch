            ...
            lambda: (
                ...
                if meta_check == True
                    ...
                    if df != None
                        ...
                        meta.get("author")["name"]
                        if meta_check == True
                        else (
                            meta[0].get("author")["name"]
                            if type(meta) == list
                            else "N/A"
                        )
                    )
        ...
        date = catch(
            ...
            lambda: (
                ...
                if meta_check == True
                    ...
                    df["datePublished"][0]
                    if df != None
                    else meta[0].get("datePublished") if type(meta) == list else "N/A"
                )
            ),
        )
        if "" != date or i == 3:
    ...
    while True:
        ...
        category = catch(
            ...
            (
                meta.get("@type")
                if meta_check == True
                else df["@type"][0] if len(df) != 0 else "N/A"
            ),
        )
        if "" != category or i == 3:
            break
